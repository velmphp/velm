...
This writes `coverage.xml` and fails if line coverage drops below the configured minimum (currently **78%**, raised incrementally toward **99%**; see [phpunit.xml](phpunit.xml) scope).
