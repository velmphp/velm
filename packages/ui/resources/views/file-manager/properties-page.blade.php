<div>
    @push('page-actions')
        ...
        <button
            type="button"
            onclick="(async () => {
                const ok = await window.pvConfirm(@js(__('Delete this file?')), { title: @js(__('Delete file')), variant: 'danger', confirmLabel: @js(__('Delete')) });
                if (!ok) return;
                ...
                else window.pvAlert(@js(__('Delete failed.')), { variant: 'danger' });
            })()"
