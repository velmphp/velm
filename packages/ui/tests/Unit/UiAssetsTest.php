...
test('ui assets expose built stylesheet and widget script paths', function (): void {
    expect(UiAssets::stylesheetPath())->toEndWith('velm.css')
        ...
        ->and(UiAssets::codeEditorScriptPath())->toEndWith('pv-code-editor.js')
        ->and(UiAssets::codeDisplayScriptPath())->toEndWith('pv-code-display.js');
});
...
test('ui assets href helpers return asset urls', function (): void {
    expect(UiAssets::stylesheetHref())->toContain('velm.css')
        ...
        ->and(UiAssets::codeEditorScriptHref())->toContain('pv-code-editor.js')
        ->and(UiAssets::codeDisplayScriptHref())->toContain('pv-code-display.js');
});
