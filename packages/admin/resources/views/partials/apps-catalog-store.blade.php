<script>
    (function () {
        function registerVelmAppsCatalogStore() {
        ...
        document.addEventListener('alpine:init', registerVelmAppsCatalogStore);
        document.addEventListener('livewire:navigated', registerVelmAppsCatalogStore);

        if (typeof Alpine !== 'undefined') {
            registerVelmAppsCatalogStore();
        }
    })();
</script>
