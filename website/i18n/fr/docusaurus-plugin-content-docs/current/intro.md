...
**Installation depuis Packagist :** `composer create-project velmphp/app my_app -s rc` — voir [Installation](./guides/installation).
...
Les guides détaillés sont encore en anglais. Consultez la version **Next** en anglais pour le contenu le plus récent.
:::
