...
**Install from Packagist:** `composer create-project velmphp/app my_app` — see [Installation](./guides/installation). Use the **version dropdown** above for docs tied to a release tag (e.g. **1.0.0**); **Next** tracks unreleased changes on `main`.
