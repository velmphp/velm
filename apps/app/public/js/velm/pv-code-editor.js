(() => {
  ...
  var MountedTree = class {
    constructor(tree, overlay, parser6, bracketed2 = false) {
      this.tree = tree;
  ...
  var InnerParse = class {
    constructor(parser6, parse, overlay, bracketed2, target, from) {
      this.parser = parser6;
      this.parse = parse;
      this.overlay = overlay;
      this.bracketed = bracketed2;
  ...
  var ActiveOverlay = class {
    constructor(parser6, predicate, mounts, index, start, bracketed2, target, prev) {
      this.parser = parser6;
  ...
  // resources/js/src/pv-code-editor.entry.js
  var languages = {
    json: () => json(),
